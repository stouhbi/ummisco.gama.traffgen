...
global{
	...
	traffgen_gen gen_NG_11 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NG_11, speed, count_2_4, 48, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen gen_NG_12 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NG_12, speed, count_5_9, 37, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen typeGen_NG_11 <- map_traffgen([gen_NG_11], typeTran);
	traffgen_gen typeGen_NG_12 <- map_traffgen([gen_NG_12], copy(typeTran));
	...
	traffgen_gen gen_NG_21 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NG_21, speed, count_10_14, 48, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen gen_NG_22 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NG_22, speed, count_10_14, 37, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen typeGen_NG_21 <- map_traffgen([gen_NG_21], typeTran);
	traffgen_gen typeGen_NG_22 <- map_traffgen([gen_NG_22], copy(typeTran));
	...
	traffgen_gen gen_NM_11 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NM_11, speed, count_5_9, 30, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen gen_NM_12 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NM_12, speed,  count_5_9, 30, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen typeGen_NM_11 <- map_traffgen([gen_NM_11], typeTran);
	traffgen_gen typeGen_NM_12 <- map_traffgen([gen_NM_12], copy(typeTran));
	...
	traffgen_gen gen_NM_21 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NM_21, speed, count_5_9, 30, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen gen_NM_22 <- atomic_traffgen([species_of(car),species_of(bus), species_of(moto)], headway_NM_22, speed, count_10_14, 30, {4652.572627816505, 2453.786642591314, 0});
	traffgen_gen typeGen_NM_21 <- map_traffgen([gen_NM_21], typeTran);
	traffgen_gen typeGen_NM_22 <- map_traffgen([gen_NM_22], copy(typeTran));
	...
	reflex generate {
		...
		if(truc!=nil){
			...
			write  " arrival time "+ truc.activated_at;
			write "at location "+truc.location;
			save (string(truc.width) + ";" + string(truc.height) + ";" + string(truc.activated_at) + ";"  + string(truc.speed) + ";" + string(truc.tiv) + ";" + truc.location.x + ":" + truc.location.y + ":" + truc.location.z) to: "../includes/VarNG.2.csv" type:"csv" rewrite:false;
		...
		if(truc!=nil){
			...
			write  " arrival time "+ truc.activated_at;
			write "at location "+truc.location;
			save (string(truc.width) + ";" + string(truc.height) + ";" + string(truc.activated_at) + ";"  + string(truc.speed) + ";" + string(truc.tiv) + ";" + truc.location.x + ":" + truc.location.y + ":" + truc.location.z) to: "../includes/VarNM.1.csv" type:"csv" rewrite:false;
