...
_operator(S("vehicle_generator"),ummisco.gama.traffgen.operators.TraffGen.class.getMethod("createGenerator", IScope.class,LI,S,IM,LI,LI,ummisco.gama.traffgen.types.SpeedGenerator.class,LI,S),C(LI,S,IM,LI,LI,ummisco.gama.traffgen.types.SpeedGenerator.class,LI,S),I(),ummisco.gama.traffgen.types.VehicleGenerator.class,F,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.VehicleGenerator run(IScope s,Object... o){return ummisco.gama.traffgen.operators.TraffGen.createGenerator(s,((IList)o[0]),((String)o[1]),((IMatrix)o[2]),((IList)o[3]),((IList)o[4]),((ummisco.gama.traffgen.types.SpeedGenerator)o[5]),((IList)o[6]),((String)o[7]));}});
