...
_species("vehicle",ummisco.gama.traffgen.species.Vehicle.class, new IAgentConstructor(){ @Override public IAgent createOneAgent(IPopulation p) {return new ummisco.gama.traffgen.species.Vehicle(p);}});};
...
_var(ummisco.gama.traffgen.species.Vehicle.class,"the type of the vehicle",desc(4,S(TYPE,"4",NAME,TYPE,CONST,FALSE)),new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public String run(IScope scope, IAgent a, IVarAndActionSupport t, Object... v) {return t == null? null:((ummisco.gama.traffgen.species.Vehicle)t).getVehicleType();}},null,new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Object  run(IScope scope, IAgent a, IVarAndActionSupport t, Object... arg) {if (t != null) ((ummisco.gama.traffgen.species.Vehicle) t).setVehicleType((String) arg[0]); return null; }});
...
_var(ummisco.gama.traffgen.species.Vehicle.class,"is the vehicle launched",desc(3,S(TYPE,"3",NAME,"launched",CONST,FALSE)),new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Boolean run(IScope scope, IAgent a, IVarAndActionSupport t, Object... v) {return t == null? false:((ummisco.gama.traffgen.species.Vehicle)t).getLaunched();}},null,new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Object  run(IScope scope, IAgent a, IVarAndActionSupport t, Object... arg) {if (t != null) ((ummisco.gama.traffgen.species.Vehicle) t).setLaunched((Boolean) arg[0]); return null; }});
_var(ummisco.gama.traffgen.species.Vehicle.class,"the width of the vehicle",desc(2,S(TYPE,"2",NAME,"width",CONST,FALSE)),new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Double run(IScope scope, IAgent a, IVarAndActionSupport t, Object... v) {return t == null? 0d:((ummisco.gama.traffgen.species.Vehicle)t).getVehicleWidth();}},null,new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Object  run(IScope scope, IAgent a, IVarAndActionSupport t, Object... arg) {if (t != null) ((ummisco.gama.traffgen.species.Vehicle) t).setVehicleWidth((Double) arg[0]); return null; }});
...
_var(ummisco.gama.traffgen.species.Vehicle.class,"the initial speed of the vehicle",desc(2,S(TYPE,"2",NAME,"init_speed",CONST,FALSE)),new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Double run(IScope scope, IAgent a, IVarAndActionSupport t, Object... v) {return t == null? 0d:((ummisco.gama.traffgen.species.Vehicle)t).getInitialSpeed();}},null,new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Object  run(IScope scope, IAgent a, IVarAndActionSupport t, Object... arg) {if (t != null) ((ummisco.gama.traffgen.species.Vehicle) t).setInitialSpeed((Double) arg[0]); return null; }});
...
_var(ummisco.gama.traffgen.species.Vehicle.class,"the height of the vehicle",desc(2,S(TYPE,"2",NAME,"height",CONST,FALSE)),new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Double run(IScope scope, IAgent a, IVarAndActionSupport t, Object... v) {return t == null? 0d:((ummisco.gama.traffgen.species.Vehicle)t).getVehicleHeight();}},null,new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Object  run(IScope scope, IAgent a, IVarAndActionSupport t, Object... arg) {if (t != null) ((ummisco.gama.traffgen.species.Vehicle) t).setVehicleHeight((Double) arg[0]); return null; }});
_var(ummisco.gama.traffgen.species.Vehicle.class,"the arrival time to the network",desc(23,S(TYPE,"23",NAME,"arrival",CONST,FALSE)),new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public GamaDate run(IScope scope, IAgent a, IVarAndActionSupport t, Object... v) {return t == null? null:((ummisco.gama.traffgen.species.Vehicle)t).getArrivalTime();}},null,new GamaHelper(ummisco.gama.traffgen.species.Vehicle.class){ @Override public Object  run(IScope scope, IAgent a, IVarAndActionSupport t, Object... arg) {if (t != null) ((ummisco.gama.traffgen.species.Vehicle) t).setArrivalTime((GamaDate) arg[0]); return null; }});
