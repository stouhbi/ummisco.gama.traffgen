...
_operator(S("location_traffgen"),ummisco.gama.traffgen.types.TrafficGenerator.class.getMethod("createLocationTrafficGenerator", IScope.class,LI,GM),C(LI,GM),AI,ummisco.gama.traffgen.types.TrafficGenerator.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficGenerator run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficGenerator.createLocationTrafficGenerator(s,((IList)o[0]),((GamaMap)o[1]));}});
...
_operator(S("gamma_law"),ummisco.gama.traffgen.types.TrafficLaw.class.getMethod("createGamma", IScope.class,D,D),C(D,D),AI,ummisco.gama.traffgen.types.TrafficLaw.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficLaw run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficLaw.createGamma(s,asFloat(s,o[0]),asFloat(s,o[1]));}});
_operator(S("inverse_gamma_law"),ummisco.gama.traffgen.types.TrafficLaw.class.getMethod("createInverseGamma", IScope.class,D,D),C(D,D),AI,ummisco.gama.traffgen.types.TrafficLaw.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficLaw run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficLaw.createInverseGamma(s,asFloat(s,o[0]),asFloat(s,o[1]));}});
_operator(S("lognormal_law"),ummisco.gama.traffgen.types.TrafficLaw.class.getMethod("createLogNormal", IScope.class,D,D),C(D,D),AI,ummisco.gama.traffgen.types.TrafficLaw.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficLaw run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficLaw.createLogNormal(s,asFloat(s,o[0]),asFloat(s,o[1]));}});
...
_operator(S("pearson_3_law"),ummisco.gama.traffgen.types.TrafficLaw.class.getMethod("createPearson3", IScope.class,D,D,D),C(D,D,D),AI,ummisco.gama.traffgen.types.TrafficLaw.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficLaw run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficLaw.createPearson3(s,asFloat(s,o[0]),asFloat(s,o[1]),asFloat(s,o[2]));}});
...
_operator(S("pearson_6_law"),ummisco.gama.traffgen.types.TrafficLaw.class.getMethod("createPearson6", IScope.class,D,D,D,D),C(D,D,D,D),AI,ummisco.gama.traffgen.types.TrafficLaw.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficLaw run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficLaw.createPearson6(s,asFloat(s,o[0]),asFloat(s,o[1]),asFloat(s,o[2]),asFloat(s,o[3]));}});
...
_operator(S("shifted_lognormal_law"),ummisco.gama.traffgen.types.TrafficLaw.class.getMethod("createShiftedLogNormal", IScope.class,D,D,D),C(D,D,D),AI,ummisco.gama.traffgen.types.TrafficLaw.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficLaw run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficLaw.createShiftedLogNormal(s,asFloat(s,o[0]),asFloat(s,o[1]),asFloat(s,o[2]));}});
