...
_operator(S("location_traffgen"),ummisco.gama.traffgen.types.TrafficGenerator.class.getMethod("cre", IScope.class,LI,IM),C(LI,IM),AI,ummisco.gama.traffgen.types.TrafficGenerator.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficGenerator run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficGenerator.cre(s,((IList)o[0]),((IMatrix)o[1]));}});
_operator(S("location_traffgen"),ummisco.gama.traffgen.types.TrafficGenerator.class.getMethod("createLocationTrafficGenerator", IScope.class,LI,IM),C(LI,IM),AI,ummisco.gama.traffgen.types.TrafficGenerator.class,false,-13,-13,-13,-13,new GamaHelper(){ @Override public ummisco.gama.traffgen.types.TrafficGenerator run(IScope s,Object... o){return ummisco.gama.traffgen.types.TrafficGenerator.createLocationTrafficGenerator(s,((IList)o[0]),((IMatrix)o[1]));}});
